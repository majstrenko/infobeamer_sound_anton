...
local videos = {
    [16] = resource.load_video{file = "1.mp4", looped = false, audio = true},
    [17] = resource.load_video{file = "2.mp4", looped = false, audio = true},
    [18] = resource.load_video{file = "3.mp4", looped = false, audio = true},
    [19] = resource.load_video{file = "4.mp4", looped = false, audio = true},
}
